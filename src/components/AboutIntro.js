...
function AboutIntro() {
    return (
        <section className="container m-auto relative">
            <div className="flex items-center justify-center p-4 lg:p-8 gap-8 lg:gap-20 flex-col lg:flex-row-reverse">
                <div className="w-full lg:w-1/2 relative z-10">
                    <h2 className="text-2xl lg:text-4xl font-heading mb-8 text-blue-extradark capitalize leading-normal">Lorem ipsum adipisicing explicabo consectetu</h2>
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center lg:p-14">
                    <div className="bg-gradient-to-br from-blue-dark to-blue-medium rounded-lg w-full h-40 lg:h-80 relative">
